...
const Footer = () => {
    return (
        <footer className="text-center lg:text-left bg-gray-800 text-gray-200">
          ...
          ">
                    ...
                    <div className="">
                        ...
                        <p className="mb-4">
                            <a href="#" className="text-gray-100">Angular</a>
                        </p>
                        <p className="mb-4">
                            <a href="#" className="text-gray-100">React</a>
                        </p>
                        <p className="mb-4">
                            <a href="#" className="text-gray-100">Vue</a>
                        </p>
                        <p>
                            <a href="#" className="text-gray-100">Laravel</a>
                        </p>
                    </div>
                    <div className="">
                        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
